...
export default function EditStudentModal({ student, onClose, onSuccess }: EditStudentModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-surface rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col border border-border border-t-4 border-t-primary">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col items-center border-r border-border pr-6 relative">
            <div className="absolute top-0 right-0 w-24 h-24 bg-secondary/5 rounded-bl-full -z-10"></div>
            <div className="w-32 h-32 border-2 border-dashed border-primary/40 rounded-3xl flex items-center justify-center text-primary/50 mb-5 bg-gradient-to-br from-primary/5 to-primary/10 shadow-inner transition-all hover:bg-primary/10 hover:border-primary hover:text-primary cursor-pointer">
              <Icon icon="mdi:camera-plus-outline" className="text-5xl" />
            </div>
            <button className="bg-surface border-2 border-primary/20 hover:border-primary hover:bg-primary/5 text-primary w-full py-2.5 rounded-xl text-sm font-bold transition-all flex justify-center items-center shadow-sm">
